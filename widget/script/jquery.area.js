...
/*定义三级省市区数据*/
var province = ["北京市", "天津市", "上海市", "重庆市", "香港特别行政区", "澳门特别行政区", "河北省", "河南省", "山西省", "山东省", "内蒙古自治区", "辽宁省", "吉林省", "黑龙江省", "江苏省", "浙江省", "福建省", "江西省", "安徽省", "湖北省", "湖南省", "广东省", "广西壮族自治区", "海南省", "四川省", "贵州省", "云南省", "西藏自治区", "陕西省", "甘肃省", "青海省", "宁夏回族自治区", "新疆维吾尔自治区", "台湾省"];
var city = [
	["市辖区"],
	["市辖区", "市辖县"],
	["市辖区"],
...
function selectD(p, c, d) {
	...
	// var sCityArr = expressArea.split(' > ');
	// var sCity = sCityArr[1];
	// if ((sCity == "市辖区" || sCity == "市辖县" || sCity == "香港岛" || sCity == "九龙半岛" || sCity == "新界" || sCity ==
	// 		"澳门半岛" || sCity == "离岛" || sCity == "无堂区划分区域")) {
	// 	sCity = sCityArr[0];
	// }
	_areaSubmit(expressArea);
	// $("#expressArea dl dd").html(expressArea);
}
